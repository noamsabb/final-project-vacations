...
import { sabbathMiddleware } from "./6-middleware/sabbath-middleware";
...
class App {
    ...
    public async start(): Promise<void> {
        ...
        server.use(expressRateLimit({
            windowMs: 1000,
            limit: 10,
            skip: (request: Request) => request.originalUrl.startsWith("/api/products/images/") // Don't block images.
        }));
        ...
        server.use(sabbathMiddleware.sabbathForbidden);
