...
export function AddVacation() {
  ...
  // Watch the startDate value from the form
...
<br />
        ...
        <input 
          ...
          {...register("endDate", {
            ...
            validate: (endDate) => {
              const startDateValue = watchedStartDate || startDate;
              if (!startDateValue) return true; // Let start date validation handle this
              return new Date(endDate) > new Date(startDateValue) || "End date must be after start date";
            }
          })}
        />
