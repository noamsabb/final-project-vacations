...
export function VacationList() {
  ...
  async function handleFilterChange(selectedFilter: string) {
    if (selectedFilter === "liked") {
      console.log("Before:", likedButton);

      setLikedButton((prevLikedButton) => {
        console.log("Inside setState - Previous:", prevLikedButton);
        console.log("Inside setState - New:", !prevLikedButton);
        return !prevLikedButton;
      });
      
      console.log("After setState (still old value):", likedButton);
    }
