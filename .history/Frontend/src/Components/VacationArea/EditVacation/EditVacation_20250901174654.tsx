    ...
    <div className="EditVacation">
      <form onSubmit={handleSubmit(send)}>
        ...
        <input
          ...
          min={startDate ? startDate.toString().split("T")[0] : new Date().toISOString().split("T")[0]}
          {...register("endDate")}
          required
        ...
        {imageUrl && <img src={imageUrl} alt="Current vacation" style={{maxWidth: '200px', maxHeight: '200px'}} />}
        <br />
