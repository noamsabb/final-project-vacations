...
console.log("user?.role === Role.User:", user?.role === Role.User);
  return (
    ...
    //     <span className="dates">{props.vacation.startDate.toString().slice(0, 10)}-{" "}
    //         {props.vacation.endDate.toString().slice(0, 10)}</span>
